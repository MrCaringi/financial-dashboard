  ...
  return (
    <div className="min-h-screen flex flex-col gap-6 p-4 pt-12 pb-32">
      <header className="flex items-center gap-4 px-2">
        ...
        <div>
          <h2 className="text-xs font-semibold tracking-widest text-zinc-400 uppercase">Accounts</h2>
      ...
      <section className="glass-card p-8 rounded-2xl text-center max-w-sm mx-auto space-y-4">
        ...
        <h2 className="text-lg font-bold text-zinc-100">Failed to load accounts</h2>
        <p className="text-xs text-zinc-400 leading-relaxed">
          We encountered an issue retrieving your bank accounts or balances.
        </p>
        <button
          onClick={reset}
